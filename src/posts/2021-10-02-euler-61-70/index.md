...
> | Pentagonal | P<sub>5,*n*</sub> = *n*(3*n*&minus;1)/2 | 1, 5, 12, 22, 35, ... |
> | Hexagonal  | P<sub>6,*n*</sub> = *n*(2*n*&minus;1)   | 1, 6, 15, 28, 45, ... |
> | Heptagonal | P<sub>7,*n*</sub> = *n*(5*n*&minus;3)/2 | 1, 7, 18, 34, 55, ... |
> | Octagonal  | P<sub>8,*n*</sub> = *n*(3*n*&minus;2)   | 1, 8, 21, 40, 65, ... |
>
...
> {.problem-example}
>
> For example, when *D* = 13, the minimal solution in *x* is 649² &minus; 13×180² = 1.
>
...
> 3² &minus; 2×2² = 1
> 2² &minus; 3×1² = 1
> **9**{.problem-highlight}² &minus; 5×4² = 1
> 5² &minus; 6×2² = 1
> 8² &minus; 7×3² = 1
> {.problem-example}
>
...
>
> ![p068_1](https://projecteuler.net/project/images/p068_1.png){.dark:invert}
>
...
>
> ![p068_2](https://projecteuler.net/project/images/p068_2.png){.dark:invert}
