...
<figure>
  <img src="./name-1.jpg" alt="name-1" class="invert" style="height: 90px; width: auto;">
  <img src="./name-2.jpg" alt="name-2" class="invert" style="height: 90px; width: auto;">
...
<figure>
  <img src="./ideo-body.png" alt="ideo-body" class="invert" style="max-width: 300px;">
...
![source-han](./source-han.png){:.black}
...
![block-printed.png](./block-printed.png){:.black}
...
![calligraphic](./calligraphic.png){:.black}
...
![hangul-bopomofo](./hangul-bopomofo.png){:.black}

以及西夏文、契丹小字和女书：

![historic](./historic.png){:.black}
